...
my $DBPATH=@ARGV[0];
my $EXPORTPATH=@ARGV[1];
print "Dumping $DBPATH to $EXPORTPATH\n";
...
#                        TESTS TIMES WORKLIST);
       ...
       my  @tables = qw(BOILER_PLATE CATEGORIES ENV FAILURES INIT KNOWN_FAILURES META_SERIES 
                        META_SERIES_COMMENT NOTES QLI$PROCEDURES SERIES SERIES_COMMENT
                        TESTS TIMES WORKLIST);
